...
const NotionTemplate: React.FC<NotionTemplateProps> = ({ data, template }) => {
  ...
  return (
    ...
    >
      {/* Notion-style subtle top border */}
      <div
        className="w-full h-1"
        style={{ backgroundColor: data.globalSettings?.themeColor || "#37352f" }}
      />
